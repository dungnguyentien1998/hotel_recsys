    ...
    methods: {
        ...
        onSubmit: function () {
            ...
            if (this.$v.form.$anyError) {
                ...
                this.form.complaint_id = this.complaint.uuid
                this.$store.dispatch('reply/resetStatus')
                this.$store.dispatch('reply/createReply', this.form)
                    .then(() => {
                        if (this.$store.getters['reply/status'] === 'FAILED') {
