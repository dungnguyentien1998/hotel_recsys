...
urlpatterns = [
    ...
    path('bookings', NewBooking.as_view(), name='new_booking'),
    path('bookings/<booking_id>', NewBookingDetail.as_view(), name='new_booking.detail'),
    path('hotels/<hotel_id>/bookings', NewHotelierBooking.as_view(), name='hotel.new_bookings'),
    path('hotels/<hotel_id>/bookings/<booking_id>', NewHotelierBookingDetail.as_view(), name='hotel.new_booking'),
    path('hotels/<hotel_id>/arrange_room', BookingRoomDetail.as_view(), name='hotel.arrange_room'),
    path('hotels/<hotel_id>/new_bookings', BookingRoom.as_view(), name='hotel.arrange_room')
]
