# Generated by Django 3.1.7 on 2021-06-04 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenities', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('free parking', 'Free Parking'), ('fitness center', 'Fitness Center'), ('breakfast', 'Breakfast'), ('swimming pool', 'Swimming Pool'), ('bar', 'Bar'), ('spa', 'Spa'), ('room service', 'Room Service'), ('non smoking icon', 'Non Smoking Icon')], max_length=32768), size=None)),
