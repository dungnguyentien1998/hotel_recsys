# Generated by Django 3.1.7 on 2021-06-17 02:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=32768, null=True, verbose_name='email')),
                ('tel', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rooms', to='app.type')),
            ],
            options={
                'db_table': 'room',
            },
